                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('user#contactList')}}">
                               <i class="fa-solid fa-address-card"></i>Contacts</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                ...
                                <div class="date-set px-2">
                                    <button class="btn btn-warning"><i class="fa-regular fa-calendar"></i>  {{date('d-m-Y')}}
                                        <i class="fa-regular fa-clock"></i>  {{date('h:i:s:A')}}
                                    </button>
                                </div>
                            </form>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            @if (Auth::user()->image==null)
                                                ...
                                                alt="John Doe" class="img-thumbnail shadow-sm"/>
                                            @else
